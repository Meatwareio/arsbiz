    ...
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-background px-6 text-foreground">
      <section className="mx-auto flex max-w-2xl flex-col items-center text-center">
        ...
        <p className="mt-10 max-w-md text-base leading-relaxed text-muted-foreground md:text-lg">
          ...
          <span className="text-foreground">phygital NFTs</span> — each token
          represents verifiable ownership of a real, physical work of art.
        </p>
        ...
        <div className="mt-14 flex flex-col items-center gap-2">
          ...
          <a
            ...
            className="text-lg font-medium underline-offset-8 transition-opacity hover:underline hover:opacity-80 md:text-xl"
          >
            admin@ars.business
          </a>
        </div>
